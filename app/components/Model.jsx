...
export default function Model(props) {
  ...
  const currentTexture = texturesMap.get(props.currentTexture) ? 
    texturesMap.get(props.currentTexture) : null

  if (currentTexture) {
    const texture = new THREE.TextureLoader().load(currentTexture)
    texture.flipY = false
  ...
  if (props.currentAvatar === '/models/model.gltf') {
  ...
  else if (props.currentAvatar === '/models/dress-animated.glb') {
  ...
  else if (props.currentAvatar === '/models/crop-top-animated.glb') {
